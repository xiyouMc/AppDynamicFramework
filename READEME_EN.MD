The Framework depeny on [Dynamic-load-apk](https://github.com/singwhatiwanna/dynamic-load-apk). Add the way of dynamic load plugs and the inspect of bundle` service.
